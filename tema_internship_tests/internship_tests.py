...
dep1 = driver.find_element(By.CSS_SELECTOR, 'div.form-combined__input1 input[name="startDate"]').send_keys("02/07/2022")

#ret = driver.find_element(By.CSS_SELECTOR, 'div.form-combined__input2 div.form-group input[name="endDate"]')
#ret1 = driver.find_element(By.CSS_SELECTOR, 'div.form-combined__input2 input[name="endDate"]').send_keys("02/27/2022")
# ret2 = driver.find_element(By.CSS_SELECTOR, 'div[data-bdd="farefinder-package-enddate-input"]').send_keys("02/27/2022")
